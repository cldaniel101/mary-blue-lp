  ...
  return (
    <main className="flex-1 flex flex-col z-20 min-h-0 overflow-hidden">
      ...
      <div className="md:hidden flex flex-col min-h-screen">
        {/* Imagem Hero Mobile - Topo */}
        <div className="relative w-full h-[49vh] min-h-[280px] overflow-hidden">
          <img
        ...
        <div className="absolute bottom-0 left-0 right-0 h-20 bg-gradient-to-t from-[#3C8DBC] via-[#3C8DBC]/80 to-transparent"></div>
        ...
        {/* Conteúdo Mobile */}
        <div className="flex-1 px-6 pt-6 pb-8 bg-[#3C8DBC] relative m-[-1px]">
          {/* Badge de localização */}
          <div
            className="inline-flex flex-row items-center px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm mb-4 relative"
            style={{
          ...
          {/* Título Principal */}
          <h1 className="text-3xl sm:text-4xl leading-tight tracking-tight font-title font-regular text-white mb-4">
            <div className="font-extrabold">Livre-se</div> das dores<br />
            e recupere sua qualidade de vida.
          </h1>

          {/* Descrição */}
          <p className="text-sm sm:text-base font-body font-regular text-white/85 leading-relaxed mb-6 max-w-md">
          ...
          <div className="flex flex-col gap-3">
            ...
            <button 
              ...
              className="px-8 py-3 rounded-full bg-transparent border border-white/30 text-white font-body font-regular text-sm transition-all duration-200 hover:bg-white/10 hover:border-white/50 cursor-pointer"
            >
              Nossos Tratamentos
            </button>
          </div>
